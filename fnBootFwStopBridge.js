...
module.exports.fnBootFwStopBridge = async event => {
    ...
    if (retval === "0") {
        ...
        if (process === 'PROCESS') {
            ...
            P/MSSTER/AJAPA001/CAN/RSP/boot_fw_start/CLOUD_0_v1-8-32_1234567890/123456789
            {
                "path": "CAN/RSP/boot_fw_start/CLOUD_0_v1-8-32_1234567890/123456789",
                "sn": "AJAPA001",
                "retval": "0"
            }
            ...
            */
            ...
            {"path":"CAN/CMD/boot_fw_start/CLOUD_0_v1-8-32_1234567890","data":{"node":"CLOUD"}}
