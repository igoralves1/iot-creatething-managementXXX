...
async function getUserDetails(email) {
    let details = {}
    try {
        const sql = `SELECT email, firstname, lastname, telephone, company, office_address_one, office_address_two, city, country,  zip_postal_code, state_province_region FROM users WHERE username = '${email}'`
