...
//
//
// async function SendEmail(user_email, userExist, serial_number, language){
//     try {
//         var body
//         var subject
...
//             // body = "Hello, <br><br>" +
//             //
//             //     "Please, click " + "<a href='https://" + weburl + "/?action=onlineaccess&email=" + user_email + "&sn=" + serial_number + "'>here</a>" + " to complete Online Access Activation.<br><br>" +
//             //
//             //
//             // "Regards,<br>" +
...
//
//             console.log("axiosconnect ==== ", axios)
//
//             let res = await axiosconnect.post(url, data)
//             console.log("AccountAssocEmail ==== ", res)
...
//         }
//
//         console.log("ready to publish MQTT ????")
//
